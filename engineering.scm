...
(define vector35-arch-arm64 (package
			     (name "vector35-arch-arm64")
			     (version "55d73c6bbb94448a5c615933179e73ac618cf876")
			     (source (origin
				      (method git-fetch)
				      (uri (git-reference
				      ...
				      (sha256
				       (base32
					"1dfhnsin3gg9w805d050zhsb30jah6vfqcb1j2hck0s3kjkp3755"))
				      (file-name (git-file-name name version))))
			     (build-system copy-build-system)
			     (synopsis #f)
			     (description #f)
...
(define vector35-arch-armv7 (package
			     (name "vector35-arch-armv7")
			     (version "f270a6cc99644cb8e76055b6fa632b25abd26024")
			     (source (origin
				      (method git-fetch)
				      (uri (git-reference
				      ...
				      (sha256
				       (base32
					"0sdj311zc2zxrjwhjp91kdyb53fhwgn98p0xirvwxjiwncky05v2"))
				      (file-name (git-file-name name version))))
			     (build-system copy-build-system)
			     (synopsis #f)
			     (description #f)
...
(define-public radare2
       ...
       #~(modify-phases %standard-phases
         (add-before 'configure 'mklibdir
           (lambda* (#:key inputs outputs #:allow-other-keys)
             ...
             #t))
	 (add-after 'unpack 'subdirs
		    (lambda* (#:key inputs outputs #:allow-other-keys)
		      (mkdir-p  "libr/arch/p/arm/v35/arch-arm64/")
		      (copy-recursively (string-append #$vector35-arch-arm64 "/arch_arm64.cpp") "libr/arch/p/arm/v35/arch-arm64/arch_arm64.cpp")
		      (copy-recursively (string-append #$vector35-arch-arm64 "/disassembler") "libr/arch/p/arm/v35/arch-arm64/disassembler")
		      (mkdir-p  "libr/arch/p/arm/v35/arch-armv7/")
		      (copy-recursively (string-append #$vector35-arch-armv7 "/armv7_disasm") "libr/arch/p/arm/v35/arch-armv7/armv7_disasm")
		      (copy-recursively (string-append #$vector35-arch-armv7 "/arch_armv7.cpp") "libr/arch/p/arm/v35/arch-armv7/arch_armv7.cpp" )
		      (copy-recursively (string-append #$vector35-arch-armv7 "/arch_armv7.h") "libr/arch/p/arm/v35/arch-armv7/arch_armv7.h" )))
	 (add-after 'configure 'patch
		    (lambda* (#:key outputs #:allow-other-keys)
		      (invoke "sed" "/git/d" "-i" "libr/arch/p/arm/v35/Makefile")))
	 (delete 'strip)
    ...
    (inputs
     (list capstone libuv openssl zip vector35-arch-arm64 vector35-arch-armv7
	   ))
    (native-inputs
     (list pkg-config))
    (propagated-inputs
